...
#endif
            VL_FATAL_MT("design_src/mul.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vmul___024root___ctor_var_reset(Vmul___024root* vlSelf) {
    ...
    vlSelf->mul__DOT__a = VL_RAND_RESET_I(4);
    vlSelf->mul__DOT__mul2 = VL_RAND_RESET_I(8);
    vlSelf->mul__DOT__mul4 = VL_RAND_RESET_I(8);
    vlSelf->mul__DOT__mul8 = VL_RAND_RESET_I(8);
    vlSelf->mul__DOT__be4 = VL_RAND_RESET_I(1);
}
